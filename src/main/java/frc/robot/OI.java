...
import frc.robot.Constants.ControllerConstants.Buttons;
...
public class OI {
	...
	private static int NUMBER_OF_CONTROLLERS = ControllerConstants.NUMBER_OF_CONTROLLERS;
	private static double DEADZONE_VALUE = ControllerConstants.DEADZONE_VALUE;
	public OI() {
	...
	public Trigger getButton(int joystick, Buttons button) {
		return buttons[joystick][button.getValue()];
	}

	public Trigger getPovButton(int joystick, int degree) {
		if (degree % 45 != 0) {
